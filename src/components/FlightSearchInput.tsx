  ...
  return (
    ...
    <div className="h-32 flex items-center max-w-[664px] m-auto">
      <input
        ...
        name="flightSearch"
        id="flightSearch"
        className="block w-full rounded-md border-0 py-1.5 pl-3 pr-20 text-[--grey-storm] ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 h-12 bg-[--white]"
